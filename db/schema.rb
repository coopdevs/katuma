...
ActiveRecord::Schema.define(:version => 20131026233929) do
  ...
  add_index "users_units", ["customer_id"], :name => "index_users_units_on_customer_id"
  ...
  add_index "waiting_lists", ["customer_id"], :name => "index_waiting_lists_on_customer_id"
